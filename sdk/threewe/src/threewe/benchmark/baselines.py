...
BASELINES: dict[str, BaselineResult] = {
    ...
    "nav2_objectnav_office": BaselineResult(
        task="objectnav",
        scene="office_v2",
        agent="nav2_default",
        num_episodes=100,
    ...
    "nav2_objectnav_apartment": BaselineResult(
        task="objectnav",
        scene="apartment_v1",
        agent="nav2_default",
        num_episodes=100,
    ...
    "nav2_pointnav_warehouse": BaselineResult(
        task="pointnav",
        scene="warehouse_v1",
        agent="nav2_default",
        num_episodes=100,
    ...
    "nav2_pointnav_cluttered": BaselineResult(
        task="pointnav",
        scene="cluttered_v1",
        agent="nav2_default",
        num_episodes=100,
    ...
    "nav2_pointnav_outdoor": BaselineResult(
        task="pointnav",
        scene="outdoor_v1",
        agent="nav2_default",
        num_episodes=100,
    ...
    "nav2_pointnav_dynamic": BaselineResult(
        task="pointnav",
        scene="dynamic_v1",
        agent="nav2_default",
        num_episodes=100,
    ...
    "frontier_exploration_warehouse": BaselineResult(
        task="exploration",
        scene="warehouse_v1",
        agent="frontier_exploration",
        num_episodes=10,
