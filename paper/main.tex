...
Key contributions include: (1)~zero-code Sim2Real transfer across four backends, (2)~reproducible open hardware at approximately \$300 BOM, (3)~AI-first API design reducing navigation code complexity by 12$\times$, (4)~standardized benchmarks with community baselines and a public leaderboard, (5)~Hardware Abstraction Layer supporting third-party robots, (6)~trajectory recording with LeRobot/Open-X format interoperability, and (7)~a domain-randomization module covering both sensor noise and communication-layer fault injection, with Hailo NPU edge VLA inference support.
