...
def generate_launch_description():
    ...
    rviz_config_arg = DeclareLaunchArgument(
        'rviz_config',
        default_value=PathJoinSubstitution([pkg_simulation, 'rviz', 'sim_default.rviz']),
    ...
    # --- ros_gz_bridge ---
    bridge_params_file = PathJoinSubstitution([pkg_simulation, 'config', 'bridge_params.yaml'])
